...
import Simmer.Std.Tags (tags, voidTag)

-- Could make polyvariadic, but want to initially just work with one param.
-- Old version, useful to reference for another way of doing it.
{-
log :: I.TempForeignFn
log params = do
    -- log $ logStr param
...
library :: I.Library
library = Tuple builtinEnv builtinOps
